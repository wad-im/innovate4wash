...
const SponsorsAndPartners = () => {
    ...
    query {
        allAirtable(filter: { table: { eq: "Sponsors/Partners" } } sort: {fields: data___Display_Order order: ASC} ) {
          edges {
            node {
              data {
                Name
    ...
    return ( 
        <SponsorsDisplay>
            <p>Innovate4WASH 2022 is an initiative by <strong><a href="https://quercus-group.com/">Quercus Group</a></strong> powered and supported by</p>
