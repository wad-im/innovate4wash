...
const BlobImage = ({className}) => {
    return ( 
        <svg viewBox="0 0 428 497" xmlns="http://www.w3.org/2000/svg" width='100%' height='100%' className={className}>
            ...
            <image width="100%" height="100%" preserveAspectRatio="xMidYMid slice" href="//images.ctfassets.net/peu4cmoyfb7d/26OcLzXIM3JHfRZQf2s2MF/ce02cb8f157bdefd306816ffa8143a9a/I4WASH_hero_image__1_.jpg" clipPath="url(#user-space)"/>P
	    </svg>
     );
}
